...
This repository houses the devcontainer and docker image for the CMP9135 Computer Vision module at the University of Lincoln.
## What is Docker?
...
3. Inside the extracted folder is a folder entitled 'CMP9135 Computer Vision' which contains the .devcontainer folder. Move 'CMP9135 Computer Vision' to wherever you like, this will be your working directory for this module.
4. Make sure Docker Desktop is running. You can minimise the window.
5. Open VS Code, go to File -> Open Folder, and select your 'CMP9135 Computer Vision' folder.
